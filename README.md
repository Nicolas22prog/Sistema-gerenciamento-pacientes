...
```
./mvnw clean package
docker build -t gerenciador-pacientes:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 gerenciador-pacientes:v1
```

Once the runtime starts, you can access the project at [http://localhost:8080/gerenciador-pacientes](http://localhost:8080/gerenciador-pacientes).
